<template>
  <div id='AdminStudentCard'>
    ...
    <div>
      <p>
        School: {{ cardData.school_id }}
      </p>
      <p>
        Teacher:
      </p>
      <p>
        Grade: {{ cardData.grade_type_id }}
      </p>
      <p>
        Language: {{ cardData.language_id }}
      </p>
    </div>
    <div class="card-group-item">
      <span v-if="cardData.IEP_date">
        <p>
          IEP Meeting: {{cardData.IEP_date | mmoment("MMM Do YYYY") }}
        </p></span>
